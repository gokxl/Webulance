...
?>
    ...
    <head>
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBwfZLkThCCQWYptWELcrp5d9uXtgvywcc&callback=myMap"></script>
        <meta charset="utf-8" />
        ...
        <script type="text/javascript">
            ...
            function gethos() {
                var hospital = document.getElementById("destination").value;
                console.log(hospital);
                for (const [key, value] of Object.entries(hospitals)) {
                    if (value == hospital) {
                        document.getElementById("hos").value = key;
                    }
                }
            }
